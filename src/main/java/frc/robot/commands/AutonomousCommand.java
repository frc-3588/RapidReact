...
public class AutonomousCommand extends CommandBase {
    ...
    private Timer auto_time = new Timer();
    private double kReverseMotorPower = 0.4;

    private double kMotorPower = 0.0;
    ...
    public void execute() {
        ...
        m_chassis.setTankPower(kReverseMotorPower, kReverseMotorPower);
    ...
    public void end(boolean interrupted) {
        ...
        m_chassis.setTankPower(kMotorPower, kMotorPower);
    }
