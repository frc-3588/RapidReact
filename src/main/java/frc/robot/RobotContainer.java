...
// Joysticks
private final XboxController driverStation = new XboxController(2);
...
// Create some buttons
final JoystickButton toggleElevatorButton = new JoystickButton(driverStation, XboxController.Button.kA.value);        
...
final JoystickButton manualUpperElevatorButton = new JoystickButton(driverStation, XboxController.Button.kA.value);        
...
final JoystickButton manualLowerElevatorButton = new JoystickButton(driverStation, XboxController.Button.kA.value);        
...
final JoystickButton toggleAcquisitionAngleButton = new JoystickButton(driverStation, XboxController.Button.kA.value);        
...
public XboxController getdriverStation() {
