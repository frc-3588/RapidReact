...
private final Joystick leftJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ToggleAcquisitionMotor", new ToggleAcquisitionMotor( m_acquisition ));
...
// Create some buttons
final JoystickButton toggleAcquisitionMotorButton = new JoystickButton(operatorController, XboxController.Button.kX.value);        
toggleAcquisitionMotorButton.whileHeld(new ToggleAcquisitionMotor( m_acquisition ) ,true);
    SmartDashboard.putData("toggleAcquisitionMotorButton",new ToggleAcquisitionMotor( m_acquisition ) );

final JoystickButton notExtendAcqusitionButton = new JoystickButton(operatorController, XboxController.Button.kBack.value);        
...
final JoystickButton extentionAcquisitionButton = new JoystickButton(operatorController, XboxController.Button.kBack.value);        
...
final JoystickButton toggleElevatorButton = new JoystickButton(operatorController, XboxController.Button.kB.value);        
...
final JoystickButton manualUpperElevatorButton = new JoystickButton(operatorController, XboxController.Button.kBack.value);        
...
final JoystickButton manualLowerElevatorButton = new JoystickButton(operatorController, XboxController.Button.kBack.value);        
