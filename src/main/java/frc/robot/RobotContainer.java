...
// Create some buttons
final JoystickButton toggleAcquisitionMotorButton = new JoystickButton(operatorController, XboxController.Button.kRightBumper.value);        
toggleAcquisitionMotorButton.whenPressed(new ToggleAcquisitionMotor( m_acquisition ) ,true);
