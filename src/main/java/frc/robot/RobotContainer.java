...
// Create some buttons
final JoystickButton manualUpperElevatorButton = new JoystickButton(rightJoystick, 2);        
...
final JoystickButton manualLowerElevatorButton = new JoystickButton(rightJoystick, 1);        
...
final JoystickButton toggleAcquisitionAngleButton = new JoystickButton(rightJoystick, 1);        
