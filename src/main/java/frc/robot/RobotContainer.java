...
private final Joystick joystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand( m_chassis, m_acquisition, m_elevator ));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand( m_chassis, m_acquisition, m_elevator ));
...
final JoystickButton angleButton = new JoystickButton(operatorController, XboxController.Button.kX.value);        
