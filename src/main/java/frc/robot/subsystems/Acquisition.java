...
public class Acquisition extends SubsystemBase {
    ...
    private int goalFullRotations = 0;
    ...
    */
    ...
    public int getCPRforAngleMotor() {
        return angleMotor.getEncoder().getCountsPerRevolution();
    }
    ...
    public void setPositionGoal(double position, int fullRotations) {
        positionGoal = position;
        goalFullRotations = fullRotations;
    }

    public void updateRotations() {
        if (getAngleMotorPosition() == getCPRforAngleMotor()) {
            fullRotationsCount++;
        }
    }

    public int getFullRotationsCount() {
        return fullRotationsCount;
    }

    public int getFullRotationsGoal() {
        return goalFullRotations;
    ...
    public void resetRotationsCount() {
        fullRotationsCount = 0;
        angleMotor.getEncoder().setPosition(0);
    }

    public void resetFullRotations() {
        goalFullRotations = 0;
    }
