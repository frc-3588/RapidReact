...
private MotorControllerGroup m_left;  
    ...
    */
    ...
    rightFront = new CANSparkMax(5, MotorType.kBrushless);//correct id #4
    leftFront = new CANSparkMax(4, MotorType.kBrushless);// should be #1
    rightRear = new CANSparkMax(1, MotorType.kBrushless);//correct id #3
    leftRear = new CANSparkMax(3, MotorType.kBrushless);// should be #5                                                                                                    
